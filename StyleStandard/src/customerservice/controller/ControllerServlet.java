...
public class ControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(url.equals("notice_write.credu")){
		...
		}else if(url.equals("qna_write.credu")){
			// review_write.credu 요청
			site = "qna_write";
			
		}
		else if(url.equals("qna.credu")){
			// review.credu 요청
			site = "qna";
			
		}
		else if(url.equals("qna_read.credu")){
			// review_read.credu 요청
			site = "qna_read";
			
			
		}
		else if(url.equals("qna_delete.credu")){
			// review_delete.credu 요청
			site = "qna_delete";
