...
public class notice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("notice.credu");
		...
		try {
			...
			// 총 게시글 개수.
			cnt = notice_DAO.notice_getPageCount();
			//페이지 번호
			tot = cnt / size;
			if (cnt % size != 0) {
				tot++;
		...
		ArrayList<noticeVO> list = notice_DAO.notice_get(start, end);
		...
		// review.jsp로 이동
		String site = "WEB-INF/view/notice_board/notice.jsp";
