...
public enum ErrorCode {
	...
	CST01("회원정보를 조회하는 도중 에러가 발생하였습니다.","/index"),
	CST02("회원정보 수정 중 에러가 발생했습니다."),
	CST03("회원정보 삭제 중 에러가 발생했습니다."),
    PD01("중복 상품 등록 중 에러가 발생했습니다."),
    PD02("상품 등록 중 에러가 발생했습니다."),
	IO01("주문정보를 입력하는 중 에러가 발생했습니다.","/order/insert.do"),
	...
	CD_404("존재하지 않는 경로입니다.","/error/404.html"),
