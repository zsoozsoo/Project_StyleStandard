...
<body>
				...
				<div class="col-lg-12">
					<div class="breadcrumb__option">
						<a href="./index.jsp"><span class="fa fa-home"></span> Home</a> <a
							href="./memberinfo.jsp">회원정보</a> <span>회원탈퇴</span>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="question-section spad">
		<div class="container">
							...
							<div class="card">
								<div class="card-heading active">
									<a class="active" data-toggle="collapse"
										data-target="#collapseOne"> 회원 탈퇴 </a>
								</div>
								<div id="collapseOne" class="collapse show"
									...
									<div class="card-body">
										<ul>
											...
											<li>각종 게시판의 게시글, 댓글 등의 데이터는 삭제되지 않습니다. 반드시 탈퇴 전 직접 삭제하셔야
												합니다.</li>
											<li>정말 탈퇴 하시겠습니까?</li>
										</ul>
									</div>
			...
			<form action="../member/memberDelete">
				<div class="col-lg-6">
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">비밀번호
						</label>
						<input type="password" class="form-control"
							id="formGroupExampleInput" name="pw_1" placeholder="비밀번호 입력">
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput2" class="form-label">비밀번호
							확인</label> 
							<input type="password" class="form-control"
							id="formGroupExampleInput2"  name="pw_2" placeholder="비밀번호 재입력">
						<button type="submit" class="site-btn btn btn-primary float-right"
							data-toggle="modal" data-target="#myModal"
							style="margin-top: 15px;">확인</button>
					</div>
