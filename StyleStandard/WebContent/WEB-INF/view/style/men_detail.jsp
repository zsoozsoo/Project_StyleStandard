            ...
            <div class="row">
                    ...
                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../../resource/img/product_m/styleM_1.jpg" class="d-block w-100" alt="...">
                          </div>
                ...
                <div class="col-md-7" style="margin-top: 35px;">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title">남자 나들이 세트</h5>
                            <h5 class="card-title pt-3 pb-3 border-top">45,000원</h5>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-6 d-grid p-1">
                                    <button type="button" class="btn btn-lg btn-danger" onclick = "location.href = '../order/product1' ">주문하기</button>
                                </div>
                            </div>
                        </div>
                    </div>
