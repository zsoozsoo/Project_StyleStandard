        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__option">
                    ...
                    <a href="../style/woman"><span class="fa fa-male"></span> woman</a>
                </div>
            </div>
        </div>
    </div>
   ...
   <!-- Three columns of text below the carousel -->
    ...
    <div class="container">
      ...
      <c:forEach items="${productList}" var="productList">
        <div class="col" style="border:thin;">
            
           <div class="card h-50">
            <a href="../style/woman_detail"><img src="../resource/img/${productList.product_img}" class="card-img-top" alt="...">
            </a>
            <div class="card-body">
              <h4 class="card-title"><a href="../style/woman_detail">${productList.product_name} </a></h4>
              <h5 class="card-subtitle" style="size:30px">${productList.product_price}원</h5>
              <br>
              <p class="card-text">${productList.product_info}</p>
            </div>
          </div>
