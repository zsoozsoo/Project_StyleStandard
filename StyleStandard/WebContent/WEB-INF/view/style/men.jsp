        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__option">
                    ...
                    <a href="../style/men"><span class="fa fa-male"></span> MEN</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
      ...
      <c:forEach items="${productList}" var="productList">
        <div class="col" style="border:thin;">
           ...
           <div class="card h-50">
            <a href="../style/men_detail"><img src="../resource/img/${productList.product_img}" class="card-img-top" alt="...">
            </a>
            <div class="card-body">
              <h4 class="card-title"><a href="../style/men_detail">${productList.product_name} </a></h4>
